...
app.setPath('userData', path.join(app.getPath('appData'), 'workrest-max'));
...
// 配置路径
const DATA_DIR = path.join(os.homedir(), '.workrest-max');
      ...
      submenu: [
        {
          ...
          click: () => {
            dialog.showMessageBox(mainWindow, {
              type: 'info',
              title: '关于 WorkRest',
              message: `WorkRest Max v${APP_VERSION}`,
